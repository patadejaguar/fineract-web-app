...
export class MatPaginationIntlService extends MatPaginatorIntl {
  ...
  getRangeLabel = (page: number, pageSize: number, length: number): string => {
    const of = this.translateService ? this.translateService.instant("paginador.OF") : "of";
  ...
  translateLabels(): void {
    this.firstPageLabel = this.translateService.instant("paginador.FIRST_PAGE");
    this.itemsPerPageLabel = this.translateService.instant("paginador.ITEMS_PER_PAGE");
    this.lastPageLabel = this.translateService.instant("paginador.LAST_PAGE");
    this.nextPageLabel = this.translateService.instant("paginador.NEXT_PAGE");
    this.previousPageLabel = this.translateService.instant("paginador.PREVIOUS_PAGE");
